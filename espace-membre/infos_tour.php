...
<head>
	...
	================================================== -->
	<meta charset="utf-8">
	<title>Messages de Vie - Tour 931</title>
	<!-- Favicon icon -->
							...
							<div class="site-nav-inner pull-left">
								...
								<div class="collapse navbar-collapse navbar-responsive-collapse">
									<ul class="nav navbar-nav">
										...
										<li>
											<a href="mes_infos.php?matricule=<?php echo $_GET["matricule"] ?>"> Modifier mes infos</a>
										</li>
										<li>
											<a href="#"> || &nbsp;&nbsp;&nbsp; B i e n v e n u e &nbsp;&nbsp;&nbsp; d a n s &nbsp;&nbsp;&nbsp; v o t r e &nbsp;&nbsp;&nbsp; e s p a c e &nbsp;&nbsp;&nbsp; m e m b r e &nbsp;&nbsp;&nbsp; ||</a>
										</li>
										<!--<li>
											<a href="#" class="dropdown-toggle" data-toggle="dropdown">Se déconnecter <i
            ...
            <div class="col-md-8">
               ...
               <!--<div class="panel-group panel-classic" id="accordionA">
                  ...
                  <div class="panel panel-default">
                      <div class="panel-heading">
                         <h4 class="panel-title">
                           <a data-toggle="collapse" class="collapsed" data-parent="#accordionA, #accordionB" href="#collapseTwo">Messages de Vie - Départements & Cellule</a>
                        </h4>
                      </div>
				...
				<form action="../admin/Controllers/ControllerEditMembre1.php" method="post" role="form">
				  ...
				  <select class="form-control form-control-depart_officiel_missionnaire" name="depart_officiel_missionnaire" id="depart_officiel_missionnaire">
								...
								{							
									...
									$sql = "SELECT DepartOfficielMissionnaire FROM missionnaire WHERE MissionnaireMatricule='".$IdentifiantMembre."'";
                     ...
                     <label>Si non, choisissez une autre date</label>
						   ...
						   value="<?php
								...
								{							
									...
									$sql = "SELECT DateAutreDepart FROM missionnaire WHERE MissionnaireMatricule='".$IdentifiantMembre."'";
               ...
               <!--<div class="panel-group panel-classic" id="accordionB">
                  <div class="panel panel-default">
					...
					<!-- LA SUITE DES CHOIX POUR LE TOUR 931 -->
