                  ...
                  <div class="row">
                     <div class="col-md-4">
                        <div class="form-group">
                           <label>Nom</label>
                        <input class="form-control form-control-name" name="nom_missionnaire" id="name" placeholder="" type="text" required>
                        </div>
                     </div>
                     <div class="col-md-4">
                        <div class="form-group">
                     ...
                     <div class="col-md-4">
                        <div class="form-group">
						   ...
						   <select class="form-control form-control-departementministeriel" name="departementministeriel" id="departementministeriel" required>
								<option></option>
					 ...
					 <div class="col-md-4">
						...
						<select class="form-control form-control-departementministeriel" name="departementtechnique" id="departementtechnique" required>
								<option></option>
